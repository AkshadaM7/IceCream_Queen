...
middleware(['auth','admin']);//post bcoz it is going to add it,n not just display
...
middleware(['auth','admin']);//then to got admincontroller to create function
...
Route::get('product_search/{id}',[AdminController::class,'product_search'])->
middleware(['auth','admin']);
